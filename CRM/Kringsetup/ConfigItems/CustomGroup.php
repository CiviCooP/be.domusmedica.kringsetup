 ...
 * @license AGPL-3.0
 */
class CRM_Kringsetup_ConfigItems_CustomGroup {

  protected $_apiParams = array();

  /**
   * CRM_Kringsetup_ConfigItems_CustomGroup constructor.
   */
  ...
  public function create($params) {
    ...
    if (!isset($this->_apiParams['title']) || empty($this->_apiParams['title'])) {
      $this->_apiParams['title'] = CRM_Kringsetup_Utils::buildLabelFromName($this->_apiParams['name']);
    }
    try {

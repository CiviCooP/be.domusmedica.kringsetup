 ...
 * @license AGPL-3.0
 */
class CRM_Kringsetup_ConfigItems_CustomField {

  protected $_apiParams = array();

  /**
   * CRM_Kringsetup_ConfigItems_CustomField constructor.
   */
  ...
  public function create($params) {
    ...
    if (!isset($this->_apiParams['label']) || empty($this->_apiParams['label'])) {
      $this->_apiParams['label'] = CRM_Kringsetup_Utils::buildLabelFromName($this->_apiParams['name']);
    }
    try {
